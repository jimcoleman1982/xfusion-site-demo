...
window.XF_LP = {
  ...
  "story": {
    "eyebrow": "From a support ticket",
    "title": "The ticket that became a $54K order",
    "text": "A corporate buyer in a regulated industry wrote in to Crowd Cow's support queue asking about gift cards for their VIP customers. The xFusion specialist embedded on Crowd Cow's team ran it end to end: scoped the order, worked through the buyer's compliance paperwork, and closed a $54,000 corporate gifting deal. Crowd Cow's leadership called it out to their own team.",
    "kicker": "Support is not just a cost to cap. Handled by someone senior, it's where buyers show up already wanting something."
  },
  "quotes": [{
  ...
  "closingText": "Tell us what your queue looks like at peak, and we'll show you exactly how we'd staff it. Worst case, you leave with a sharper plan than you came in with."
};
function App() {
