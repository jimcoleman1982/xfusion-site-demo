...
function Leadership() {
  ...
  return /*#__PURE__*/React.createElement(Section, {
    ...
    ...person
        ...
        /* Tap-to-flip is a touch affordance only. On hover-capable (desktop)
           devices the photo already flips on hover, so a pointer cursor would
           promise a link the click doesn't deliver -> dead clicks in Clarity.
           When per-person LinkedIn URLs exist, wrap the card in an <a> instead. */
        @media (hover: none) {
          .leader-photo-stack { cursor: pointer; }
        }
        @media (hover: hover) {
