  ...
  return (
    <footer style={{ background: '#1F1A17', color: '#F7F2EB', padding: '64px 0 32px' }}>
      <Container>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              <span style={{
                ...
                fontFamily: "'Source Serif 4', serif",
                fontWeight: 500, fontSize: 22, letterSpacing: '-0.02em', lineHeight: 1,
              }}>xF</span>
              <span style={{
                fontFamily: "'Source Serif 4', serif",
                fontSize: 26, fontWeight: 500, letterSpacing: '-0.025em', color: '#F7F2EB',
              }}>xFusion</span>
            </div>
            <p style={{
              fontSize: 14, lineHeight: 1.6, color: '#9E9388',
          ...
          {cols.map(col => (
            <div key={col.title}>
              <div style={{
                ...
                letterSpacing: '0.12em', color: '#9E9388', marginBottom: 16,
              }}>{col.title}</div>
              <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
                {col.links.map(l => (
                  <li key={l.label} style={{ marginBottom: 10 }}>
                    <a href={l.href} style={{ color: '#F7F2EB', textDecoration: 'none', fontSize: 14 }}>{l.label}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div style={{
          paddingTop: 24, borderTop: '1px solid #3A322D',
          display: 'flex', justifyContent: 'space-between', alignItems: 'center',
          fontSize: 13, color: '#9E9388', flexWrap: 'wrap', gap: 12,
        }}>
